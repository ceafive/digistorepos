...
import { intersection, intersectionWith, isEqual, upperCase } from "lodash";
import React from "react";
import { useForm } from "react-hook-form";
import { useDispatch, useSelector } from "react-redux";

const paymentOptions = ["RCPAYMT", "CASH", "VISAG", "QRPAY", "BNKTR", "MTNMM", "TIGOC", "VODAC", "GCBMM"];
...
const ProcessSale = () => {
  ...
  const response = intersection(paymentOptions, userDetails?.user_permissions);
